...
// Network Credentials
const char* my_ssid = "Zoltu";
const char* my_password = "1029384756";
const char* my_mqtt_server = "192.168.50.47";
...
void setup() {
  ...
  mqttClient.publish("esp/water_tank_1", waterLevelStr1);
  mqttClient.publish("esp/water_tank_1", waterLevelStr1);
  mqttClient.publish("esp/water_tank_1", waterLevelStr1);
  ...
  mqttClient.publish("esp/water_tank_2", waterLevelStr2);
  mqttClient.publish("esp/water_tank_2", waterLevelStr2);
  mqttClient.publish("esp/water_tank_2", waterLevelStr2);
